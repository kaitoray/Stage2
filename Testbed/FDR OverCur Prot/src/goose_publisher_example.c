...
int main(int argc, char** argv)
{
    ...
    int OriCBstval [7] = {0,0,0,0,0,0,0};
    int PreCBstval [7] = {0,0,0,0,0,0,0};
	...
	gooseCommParameters.appId = 0x8003;
	...
	if (publisher) {
	    GoosePublisher_setGoCbRef(publisher, "SimulationTestbed/PIOC$FDR$CBStval");
	    GoosePublisher_setTimeAllowedToLive(publisher, 2000);    
	    GoosePublisher_setDataSetRef(publisher, "SimulationTestbed/PIOC$CBStval");
	    GoosePublisher_setGoID(publisher , "PIOC_FDR_CBStval");
