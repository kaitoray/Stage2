...
/*
//Open File//
    	fp=fopen("/media/sf_sharing/Simulation testbed for Stage 1/Datasets/CB_status/BFP.csv","a");
...
{
    printf("GOOSE event: BFP_CBStval\n");
...
//############### store CBstval to local for control signal ##########################//  
    //Open File//
    	fp=fopen("/home/ray/Desktop/GOOSESub/TripRecord/TripFromBFP.csv","w");
...
/*    
    ...
    //Close file//
    	fclose(fp);
*/    		
    GooseSubscriber subscriber = GooseSubscriber_create("SimulationTestbed/BFP$FDR$CBStaval", NULL);
