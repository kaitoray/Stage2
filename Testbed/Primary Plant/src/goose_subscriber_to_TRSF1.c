...
//############### store CBstval to local for control signal ##########################// 
    //Open File//
    	fp=fopen("/home/ray/Desktop/GOOSESub/TripRecord/TripFromTRSF1.csv","w");
...
/*
    ...
    //write values to file//
	fprintf(fp,"year,month,day,hour,minute,second,millisecond,UTC,CB1-66KV,CB2-66KV,CB-TRSF1,CB2-22KV,stNum,sqNum\n");
    //Close file//
    	fclose(fp);
*/    	
