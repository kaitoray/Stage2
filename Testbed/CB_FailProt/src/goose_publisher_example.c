...
int main(int argc, char** argv)
{
    ...
    int OriCBstval [5] = {0,0,0,0,0};
    int PreCBstval [5] = {0,0,0,0,0};
	...
	if (publisher) {
	    GoosePublisher_setGoCbRef(publisher, "SimulationTestbed/BFP$FDR$CBStaval");
	    GoosePublisher_setTimeAllowedToLive(publisher, 2000);
	    GoosePublisher_setDataSetRef(publisher, "SimulationTestbed/BFP$CBStaval");
	    GoosePublisher_setGoID(publisher , "BFP_CBStaval");
	    ...
	    //Open File//
	    	fp=fopen("/home/ray/Desktop/CB_FailProt/TripRecord/TripFromPLC.csv","r");
	    	if(fp==NULL) {
