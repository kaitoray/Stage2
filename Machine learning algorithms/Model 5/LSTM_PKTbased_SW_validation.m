...
%Learning case (still learn imba6 as that is how ConvertPKTSW.m design)
Case=Imba6;
...
[X,Y,Z] = ConvertPKTSW(revdata,label,windowsize,sliding,inputSize);
...
% Extract streaming data into defined sliding window form 
[XTEST,YTEST] = ConvertPKTSW(revtestdata,testlabel,windowsize,sliding,inputSize);
